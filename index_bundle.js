...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/style.css */ \"./src/css/style.css\");\n/* harmony import */ var _changeNumberOfRows__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./changeNumberOfRows */ \"./src/ts/changeNumberOfRows.ts\");\n/* harmony import */ var _changeNumberOfColumns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./changeNumberOfColumns */ \"./src/ts/changeNumberOfColumns.ts\");\n/* harmony import */ var _startGame__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./startGame */ \"./src/ts/startGame.ts\");\n\n\n\n\nconst app = document.querySelector(\".app\");\nconst inputForRows = app.querySelector(\".app__input\");\nconst inputForColumns = app.querySelector(\".app__input2\");\nconst buttonStartGame = app.querySelector(\".app__button2\");\nconst table = app.querySelector(\"table\");\nconst inputRange = app.querySelector(\"#range\");\nconst label = app.querySelector(\"#label\");\nlabel.innerText = inputRange.value;\nconst pause = {\n  status: false\n};\ninputForRows.addEventListener(\"change\", () => {\n  Object(_changeNumberOfRows__WEBPACK_IMPORTED_MODULE_1__[\"changeNumberOfRows\"])(table, inputForRows);\n});\ninputForColumns.addEventListener(\"change\", () => {\n  Object(_changeNumberOfColumns__WEBPACK_IMPORTED_MODULE_2__[\"changeNumberOfColumns\"])(table, inputForColumns);\n});\nbuttonStartGame.addEventListener(\"click\", () => {\n  if (buttonStartGame.innerText !== \"stop\") {\n    buttonStartGame.innerText = \"stop\";\n    pause.status = false;\n    const delayStart = 1000 / Number(inputRange.value);\n    setTimeout(() => {\n      Object(_startGame__WEBPACK_IMPORTED_MODULE_3__[\"startGame\"])(pause, table, inputRange);\n    }, delayStart);\n  } else {\n    buttonStartGame.innerText = \"start\";\n    pause.status = true;\n  }\n});\ntable.addEventListener(\"click\", e => {\n  if (buttonStartGame.innerText === \"stop\") {\n    buttonStartGame.innerText = \"start\";\n    pause.status = true;\n  }\n\n  const cell = e.target;\n\n  if (cell.style.backgroundColor === \"grey\") {\n    cell.style.backgroundColor = \"white\";\n  } else {\n    cell.style.backgroundColor = \"grey\";\n  }\n});\ninputRange.addEventListener(\"change\", () => {\n  label.innerText = inputRange.value;\n});\n\n//# sourceURL=webpack:///./src/ts/index.ts?");
